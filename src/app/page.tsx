...
export default function Home() {
    return (
        <div className="flex flex-col justify-center items-center min-h-screen bg-gray-50">
            <div className="max-w-5xl p-6 bg-white rounded-lg shadow-lg w-full min-h-[40vh] flex mb-8 mt-8"> {/* 修改 */}
                <div className="flex font-sans mx-auto px-4 space-x-6 w-full">
                    {/* 图片容器 */}
                    <div className="flex-1 relative overflow-hidden h-full"> {/* 修改 */}
                        <ReactCompareImage
                            leftImage="https://vip.helloimg.com/i/2024/05/31/66598f2a5fca0.jpg"
                            rightImage="https://vip.helloimg.com/i/2024/05/31/66598f2a8f1c7.jpg"
                        />
                    </div>
                    {/* 表单 */}
            ...
            <div className="max-w-5xl p-6 bg-white rounded-lg shadow-lg w-full min-h-[40vh] flex mb-8"> {/* 修改 */}
                <div className="flex font-sans mx-auto px-4 space-x-6 w-full">
                    ...
                    <div className="flex-1 relative overflow-hidden h-full"> {/* 修改 */}
                        <ReactCompareImage
                            leftImage="https://vip.helloimg.com/i/2024/05/31/665991409d986.png"
                            rightImage="https://vip.helloimg.com/i/2024/05/31/665991410dad5.jpg"
                        />
                    </div>
                    {/* 表单 */}
                    <form className="flex-1 p-6 h-full flex flex-col justify-between"> {/* 修改 */}
            ...
            <div className="max-w-5xl p-6 bg-white rounded-lg shadow-lg w-full min-h-[40vh] flex mb-8"> {/* 修改 */}
                <div className="flex font-sans mx-auto px-4 space-x-6 w-full">
                    ...
                    <div className="flex-1 relative overflow-hidden h-full"> {/* 修改 */}
                        <ReactCompareImage
                            leftImage="https://vip.helloimg.com/i/2024/05/31/66599140c571e.png"
                            rightImage="https://vip.helloimg.com/i/2024/05/31/66599145d70a6.png"
                        />
                    </div>
                    {/* 表单 */}
                    <form className="flex-1 p-6 h-full flex flex-col justify-between"> {/* 修改 */}
            ...
            <div className="max-w-5xl p-6 bg-white rounded-lg shadow-lg w-full min-h-[40vh] flex mb-8"> {/* 修改 */}
                <div className="flex font-sans mx-auto px-4 space-x-6 w-full">
                    ...
                    <div className="flex-1 relative overflow-hidden h-full"> {/* 修改 */}
                        <ReactCompareImage
                            leftImage="https://vip.helloimg.com/i/2024/03/24/65ffe0a2e699a.jpg"
                            rightImage="https://vip.helloimg.com/i/2024/05/31/6659920e0a71b.jpg"
                        />
                    </div>
                    {/* 表单 */}
                    <form className="flex-1 p-6 h-full flex flex-col justify-between"> {/* 修改 */}
